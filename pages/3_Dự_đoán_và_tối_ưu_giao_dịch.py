...
st.markdown("""
    <header class="header-bg">
        <div class="text-center">
            ...
            <h1 class="main-title text-5xl font-bold mb-4 gradient-text">DABAFIN - DỰ ĐOÁN CỔ PHIẾU</h1>
            <p class="text-xl text-slate-300 mb-6">Đánh giá, dự đoán tình hình biến động giá cổ phiếu dài hạn và ngắn hạn, tối ưu đầu tư</p>
